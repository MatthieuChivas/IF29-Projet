...
table_img_path = os.path.join(visuel_dir, "moyenne_variables_clusters_plus5.png")
save_summary_table(summary, counts, table_img_path, "Moyenne des variables par cluster (>5 tweets)")
...
plt.title("Projection PCA des profils utilisateurs (>5 tweets)")
...
plt.legend()
pca_img_path = os.path.join(visuel_dir, "pca_clusters_plus5.png")
...
plt.title("Ratio de réputation vs fréquence de publication (>5 tweets)")
plt.colorbar(label="Cluster")
rep_img_path = os.path.join(visuel_dir, "reputation_vs_frequency_plus5.png")
